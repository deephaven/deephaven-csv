...
```shell
java -jar build/libs/deephaven-csv-0.18.0-SNAPSHOT-jmh.jar -prof gc -rf JSON
```

```shell
java -jar build/libs/deephaven-csv-0.18.0-SNAPSHOT-jmh.jar -prof gc -rf JSON <regex>
```
