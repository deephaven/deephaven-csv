...
public class Renderer {
    ...
    public static <T> String renderList(
            Iterable<T> items, final String separator, Function<T, String> renderer) {
     ...
     */
    public static <T> StringBuilder renderList(
            StringBuilder sb, Iterable<T> items, final String separator, Function<T, String> renderer) {
